...
Maybe try "shaking" it out of local optima by adding random perturbations? If the result after perturbation is better, keep it, otherwise, try again

Also look into global optimization via genetic algorithms, simulated annealing, or particle swarm
...
#     # [2, 2, 2, 3, 3, 1, 1, 1, 1],
#     # [3,3,3,3,6,6,6,9,9]
#     [1+2**0.5, 1+2**0.5, 1+2**0.5, 1+2**0.5,1+2**0.5, 1,1,1,1], #frog base
#     # [1+2**0.5, 1+2**0.5, 1+2**0.5, 1+2**0.5,1], #bird base
#     # [1+2**0.5, 1+2**0.5,1,1] #fish base
#     # [1,1,1]
# ] * N
...
# print(f"Time taken: {time.time() - t0:.2f}s")
# display_multiple(oct_list, flap_lengths_list[:n], ngon=8)