...
export const TILING_FLAP_VERTEX_RADIUS_PX = 7
export const TILING_INTERMEDIATE_VERTEX_RADIUS_PX = 5
export const TILING_SKELETON_VERTEX_RADIUS_PX = 5
export const TILING_SKELETON_LOCK_RING_RADIUS_PX = 15
